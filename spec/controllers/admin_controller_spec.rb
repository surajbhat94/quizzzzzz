 ...
 # let(:valid_session) { {} }
  ...
  describe "#index" do
    it "collects all of the exams" do
      expect(Admin).to receive(:all).and_return(exams)
      get :index
    end
    it "displays all exams" do
      allow(Admin).to receive(:all).and_return(exams)
  ...
  describe "#destroy" do
    ...
    it 'calls the find method to retrieve a mark' do
